...
<a name="fig:micropipette"></a>

![Pipette (tip not shown). Courtesy of Thermo Fisher Scientific. Reprinted by permission.](imgs/equipment_micropipette.jpg)
...
<a name="fig:pipettes"></a>

![Two transfer pipettes: a measuring pipette (left) and volumetric pipette (right).](imgs/equipment_pipets.jpg)
...
<a name="fig:serological"></a>

![Serological pipettes are designed to leave a small amount of solution in the tip. Do not dispense this extra volume of solution.](imgs/equipment_tip.jpg)
...
<a name="fig:volflask"></a>

![Volumetric flasks are used to prepare solutions with precise volumes.](imgs/equipment_volflask.jpg)
...
<a name="fig:pHmeter1"></a>

![AB150 pH meter. Courtesy of Thermo Fisher Scientific. Reprinted by permission.](imgs/equipment_pHmeterAB150_overview.png)
...
<a name="fig:pHmeter2"></a>

![Accumet AB150 pH meter screen, including command keys on the side. Courtesy of Thermo Fisher Scientific. Reprinted by permission.](imgs/equipment_pHmeterAB150_screen.png)
...
<a name="fig:spec200_1"></a>

![Spectronic 200 Scan setup screen (left) and scan mode screen (right). Courtesy of Thermo Fisher Scientific. Reprinted by permission.](imgs/equipment_spec200_1.svg)
...
<a name="fig:spec200_2"></a>

![Spectronic 200 Live display setup screen (left) and Live display mode screen (right). Courtesy of Thermo Fisher Scientific. Reprinted by permission.](imgs/equipment_spec200_2.svg)
...
<a name="fig:cary60_home"></a>

![Cary 60 Scan application's home screen.](imgs/equipment_cary60_home.png)
...
![Advanced scan controls dialog box (left) and the baseline tab dialog box (right).](imgs/equipment_cary60_setup2.svg)
...
![Naming the data file dialog box.](imgs/equipment_cary60_filename1.png)

**Figure 15** - Naming the data file dialog box.

<a name="fig:cary60_filename2"></a>

![Sample name dialog box.](imgs/equipment_cary60_filename2.png)
